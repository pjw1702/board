...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			<div class="container">
				<h1>Huervertech 웹 게시판</h1>
				<p>이 웹 사이트는 휴버텍 CSP 사업본부의 연구 개발을 하는 과정에서 구현한 웹 게시판 사이트입니다. </p>
				<br>
				<p><a class="btn btn-primary btn-pull" href="login.jsp" role="button">로그인 하기</a> <a class="btn btn-primary btn-pull" href="bbs.jsp" role="button">게시판으로 이동하기</a></p>
			</div>
		</div>
	</div>
